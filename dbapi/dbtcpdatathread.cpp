...
bool DbTcpDataThread::checkDbLocal()
{
    ...
    dbOkLocal ? (errorCountLocal = 0) : errorCountLocal++;
...
bool DbTcpDataThread::checkDbNet()
{
    ...
    dbOkNet ? (errorCountNet = 0) : errorCountNet++;
...
void DbTcpDataThread::setCheckConn(bool checkConn)
{
